...
class AddEditMatches extends Component {
    ...
    updateFields(match, teamOptions, teams, type, matchId) {
        const newFormdata = {
            ...this.state.formdata //make a copy of state
        }
    ...
    submitForm(event) {
        ...
        this.state.teams.forEach((team) => { //adding thumbnail
    ...
    render() {
        return (
        <Sidebar>
            <div className="editmatch-dialog__wrapper">
                ...
                <div>
                    <form onSubmit={(event) => this.submitForm(event)}>
                        ...
                        <div className="select-team__layout">
